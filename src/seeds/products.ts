export const initProducts = [
  {
    ...
    images: ["/images/categories/air-force.webp"],
    description:
    ...
    quantity: 93,
    price: 1387,
    categoryId: "clccamgxc0000p3rf9tgn0wo9",
  },
  {
    name: "SB Dunk Low Concepts Orange Lobster",
    images: ["/images/categories/dunks.webp"],
    description:
    ...
    quantity: 297,
    price: 700,
    categoryId: "clccamgxc0002p3rft9tmijz4",
  },
  {
    name: "Jordan 1 Retro High OG SP Fragment x Travis Scott",
    images: ["/images/categories/airmax.png"],
    description:
  ...
  },
  {
    ...
    images: ["/images/categories/jordan.png"],
    description:
